    ...
    async execute(interaction) {
        ...
        if (result.success) {
            ...
            const embed = new EmbedBuilder()
                ...
                .setTitle(` ${targetUser.username} has been demoted`)
                .setThumbnail(targetUser.displayAvatarURL({ dynamic: true, size: 128 }))
                .setDescription(`**${result.oldRank}**  **${result.newRank}**`)
                .addFields(
                ...
                .setFooter({ 
                    text: `Demoted by ${interaction.user.username}`,
            ...
            // Check if lowest rank
            if (newRankIndex === 0) {
                embed.addFields({ 
                    name: ' Lowest Rank', 
                    value: `${targetUser.username} is now at the entry level.`,
                    inline: false 
                });
            }
